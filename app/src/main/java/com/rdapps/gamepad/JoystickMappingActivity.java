...
public class JoystickMappingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int instructionText = joystickType == RIGHT_JOYSTICK
                ? R.string.push_right_joystick_up : R.string.push_left_joystick_up;
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        for (Map.Entry<Integer, String> axisEntry : AXIS_NAMES.entrySet()) {
            ...
            if (maxedAxis != 0) {
                ...
                if (state == State.Y) {
                    resultView.setText(
                            this.getString(R.string.axis_registered, "Y", axisEntry.getValue()));
                    ...
                    resultView.setText(
                            this.getString(R.string.axis_registered, "X", axisEntry.getValue()));
