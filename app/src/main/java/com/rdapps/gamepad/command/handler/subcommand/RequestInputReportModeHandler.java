 ...
 * TODO x31 input report has all zeroes for IR/NFC data if a 11 output report with
 *  subcmd 03 00/01/02/03 was not sent before.
 */
class RequestInputReportModeHandler implements SubCommandHandler {
    private static final String TAG = RequestInputReportModeHandler.class.getName();
